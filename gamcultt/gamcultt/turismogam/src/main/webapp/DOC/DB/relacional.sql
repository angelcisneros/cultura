...
CREATE TABLE IF NOT EXISTS `gamcultt`.`taller` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `categoria_taller` INT(11) NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
  `descripcion` TEXT NOT NULL,
  `categoria` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_taller_CATEGORIA_TALLER1_idx` (`categoria_taller` ASC),
  CONSTRAINT `fk_taller_CATEGORIA_TALLER1`
    FOREIGN KEY (`categoria_taller`)
...
CREATE TABLE IF NOT EXISTS `gamcultt`.`evento` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `sala` INT(11) NOT NULL,
  `categoria_evento` INT(11) NOT NULL,
  `nombre` VARCHAR(45) NOT NULL,
  ...
  INDEX `fk_evento_CATEGORIA_EVENTO1_idx` (`categoria_evento` ASC),
  CONSTRAINT `fk_evento_CATEGORIA_EVENTO1`
    FOREIGN KEY (`categoria_evento`)
